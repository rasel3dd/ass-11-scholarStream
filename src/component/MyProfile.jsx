...
const MyProfile = () => {
    ...
    const isAdmin = true; // পরে আপনার রোল লজিক দিয়ে রিপ্লেস করবেন
                    ...
                    <div className='mt-10 grid grid-cols-1 md:grid-cols-2 gap-6'>
                        ...
                        <div className='flex items-center p-4 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm'>
                            ...
                            <div>
                                ...
                                <p className='text-gray-700 font-medium text-green-600'>Active</p>
                            </div>
                        </div>
                        ...
                        <div className='flex items-center p-4 bg-gray-50 rounded-2xl border border-gray-100 shadow-sm'>
                            ...
                            <button className='text-sm font-bold text-gray-700 hover:text-green-600 transition'>
